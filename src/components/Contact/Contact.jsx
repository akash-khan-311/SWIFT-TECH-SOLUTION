              ...
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-slate-400">5310 Kamarpukur</p>
                    <p className="text-slate-400">Saidpur, Nilfamari</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-slate-400">Mobile:+880 1719-68 1150</p>
                    <p className="text-slate-400">
                      Mail: mdakashkhanbdinto@gmail.com
                    </p>
                  </div>
                </li>
                <li className="flex">
            ...
            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
              ...
              <form id="contactForm">
                ...
                <div className="text-center">
                  <button className="w-full bg-[#66FCF1] font-bold px-6 py-3 font-xl rounded-md sm:mb-0">
                    Send Message
                  </button>
                </div>
              </form>
